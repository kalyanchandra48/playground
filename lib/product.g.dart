...
Product _productDeserialize(
  ...
  final object = Product(
    category: reader.readStringOrNull(offsets[0]) ?? 'snacks',
    description: reader.readStringOrNull(offsets[1]),
    id: id,
    name: reader.readStringOrNull(offsets[3]) ?? 'Lays',
    popularity: reader.readLongOrNull(offsets[4]),
  );
  return object;
}
...
P _productDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? 'snacks') as P;
    case 1:
      return (reader.readStringOrNull(offset)) as P;
    case 2:
      return (reader.readLong(offset)) as P;
    case 3:
      return (reader.readStringOrNull(offset) ?? 'Lays') as P;
    case 4:
...
List<IsarLinkBase<dynamic>> _productGetLinks(Product object) {
  return [object.prices, object.variants];
}

void _productAttach(IsarCollection<dynamic> col, Id id, Product object) {
  object.id = id;
  object.prices.attach(col, col.isar.collection<Price>(), r'prices', id);
  object.variants
      .attach(col, col.isar.collection<ProductVariant>(), r'variants', id);
}
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> popularityIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> popularityIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'popularity',
      ));
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> popularityEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'popularity',
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> popularityGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> popularityLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> popularityBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQueryLinks
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> pricesIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByPopularity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'popularity', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByPopularityDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByPopularity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'popularity', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByPopularityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'popularity', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByPopularity() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, int?, QQueryOperations> popularityProperty() {
    return QueryBuilder.apply(this, (query) {
